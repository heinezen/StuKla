...
/**
 * Eine Single-Choice Frage die zus�tzlich noch Quelltext und/oder ein Bild enth�lt. Diese Klasse
 * erweitert die Single-Choice Fragen.
 *
 * @author Christophad
 */
public class OptionalAuswahlFrage extends AuswahlFrage implements OptionalFrage
{
    ...
    /**
     * Erstellt eine Single-Choice Frage, die mehrere Single-Choice Antworten und au�erdem Quelltext
     * und ein Bild enth�lt.
     *
    ...
    /**
     * Erstellt eine Single-Choice Frage, die mehrere Single-Choice Antworten und au�erdem ein Bild
     * enth�lt.
     *
     * @param fragetext Der Fragetext.
     * @param fragepunkte Die Punkte f�r eine richtige Antwort.
